...
public class SimplifiedShapeTestGJKOnly extends ApplicationAdapter {
    private static final Logger logger = LogManager.getLogger(SimplifiedShapeTestGJKOnly.class);
